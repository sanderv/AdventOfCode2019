...
class Day14Test {
    ...
    internal fun `example 4`() {
        assert("""  2 VPVL, 7 FWMGM, 2 CXFTF, 11 MNCFX => 1 STKFG
    ...
    @Test
    internal fun `example 5`() {
        assert("""  171 ORE => 8 CNZTR
    ...
    @Test
    internal fun `part 1 solution should be 502491`() {
