...
internal class Day7Test {
    ...
    internal fun `should find answers to part 1 examples`(intCode: String, expectedAnswer: Int) {
    ...
    internal fun `should find answers to part 2 examples`(intCode: String, expectedAnswer: Int) {
